...
git clone https://github.com/your-username/api-linkedin-scraper.git
cd api-linkedin-scraper
...
- **Base URL**: http://localhost:8080/v1/linkedin/
...
```bash
curl -H "Authorization: Bearer dev-linkedin-key" \
     http://localhost:8080/v1/linkedin/endpoint
```
...
curl -H "X-RapidAPI-Proxy-Secret: your-secret" \
     ...
     https://your-api.p.rapidapi.com/v1/linkedin/endpoint
```
...
```bash
# Build image
docker build -t api-linkedin-scraper .

# Run container
docker run -p 8080:8080 \
  -e LINKEDIN_SCRAPER_API_KEY=your-key \
...
2. Repository: `your-username/api-linkedin-scraper`
...
| `LINKEDIN_SCRAPER_API_KEY` | Service API key | dev-linkedin-key |
...
LINKEDIN_SCRAPER_API_KEY=your-development-key
```
...
LINKEDIN_SCRAPER_API_KEY=your-production-api-key
...
2. **Docker Build Issues**
   ...
   docker build --no-cache -t api-linkedin-scraper .
   ```
